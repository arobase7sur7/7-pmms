...
!function(){function e(e){if(!e||"function"!=typeof e.Player||e.Player.__pmmsParentPatch)return e;var t=e.Player,n=function(e,n){n=n||{};n.parent&&n.parent.length||(n.parent=[window.location.hostname||"localhost"]);return new t(e,n)};try{Object.keys(t).forEach(function(e){n[e]=t[e]}),n.prototype=t.prototype}catch(e){}return n.__pmmsParentPatch=!0,e.Player=n,e}try{var t=window.Twitch;e(t),Object.defineProperty(window,"Twitch",{configurable:!0,get:function(){return t},set:function(n){t=e(n)}})}catch(e){}}();
